...
$url = "https://restaurantesofi.000webhostapp.com/serviciosMuebles/editarProducto.php?idProducto=".$idProducto."&producto=".$producto."&descripcion=".$descripcion."&precio=".$precio."&stock=".$stock;
